...
return function (PDO $pdo): void {
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS `tasks_tasks` (
            ...
            `linked_type` VARCHAR(20) NULL COMMENT 'نوع الكيان المرتبط: document/asset/employee',
            `linked_id` INT UNSIGNED NULL COMMENT 'معرّف الكيان المرتبط',
            `linked_label` VARCHAR(200) NULL COMMENT 'اسم الكيان المرتبط (لقطة للعرض)',
