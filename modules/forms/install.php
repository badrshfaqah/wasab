...
return function (PDO $pdo): void {
    ...
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS `forms_settings` (
            ...
            `margin_top` SMALLINT UNSIGNED NOT NULL DEFAULT 35 COMMENT 'هامش نص الخطاب العلوي بالمليمتر - يتكرر مع كل صفحة',
            `margin_bottom` SMALLINT UNSIGNED NOT NULL DEFAULT 28 COMMENT 'هامش نص الخطاب السفلي بالمليمتر',
            `margin_x` SMALLINT UNSIGNED NOT NULL DEFAULT 25 COMMENT 'هامش نص الخطاب يميناً ويساراً بالمليمتر',
