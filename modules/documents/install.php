...
return function (PDO $pdo): void {
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS `documents_templates` (
            ...
            `qr_enabled` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'إظهار رمز QR للتحقق على المستند',
            ...
            `margin_top` SMALLINT UNSIGNED NOT NULL DEFAULT 30 COMMENT 'هامش النص العلوي بالمليمتر - يتكرر مع كل صفحة',
            `margin_bottom` SMALLINT UNSIGNED NOT NULL DEFAULT 25 COMMENT 'هامش النص السفلي بالمليمتر',
            `margin_x` SMALLINT UNSIGNED NOT NULL DEFAULT 22 COMMENT 'هامش النص يميناً ويساراً بالمليمتر',
            `show_title` TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'طباعة عنوان المستند على الورقة',
            `title_position` ENUM('below_date','above_date') NOT NULL DEFAULT 'below_date' COMMENT 'العنوان أسفل سطر التاريخ/الرقم أم أعلاه',
