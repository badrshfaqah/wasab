...
<div class="page-head">
    <div><h1>أختام الشركة</h1><p>المكتبة العامة المتاحة لكل الموظفين — تُربط بقوالب المستندات والنماذج فتُطبَّق تلقائياً على ما يُولَّد منها. أما ختمك الشخصي فترفعه من <a href="<?= route('/profile') ?>">ملفك الشخصي</a> وتشاركه مع من تختار.</p></div>
</div>
